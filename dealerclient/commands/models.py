...
class List(base.DealerLister):
    ...
    def _get_resources(self, args):
        ...
        return dealer_client.models.list(args.workspace)
...
class Get(show.ShowOne):
    ...
    def take_action(self, args):
        dealer_client = self.app.client
        model = dealer_client.models.get(args.workspace, args.name)
...
class Create(show.ShowOne):
    ...
    def take_action(self, args):
        dealer_client = self.app.client
        model = dealer_client.models.create(
            args.workspace,
            args.name,
...
class Delete(command.Command):
    ...
    def take_action(self, args):
        ...
        utils.do_action_on_many(
            lambda s: dealer_client.models.delete(args.workspace, s),
            args.name,
...
class Update(show.ShowOne):
    ...
    def take_action(self, args):
        dealer_client = self.app.client
        model = dealer_client.models.update(
            args.workspace,
            args.name,
            display_name=args.display_name,
