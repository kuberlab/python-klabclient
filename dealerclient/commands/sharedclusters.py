...
class ListAvailable(base.DealerLister):
    ...
    def _get_resources(self, args):
        ...
        return dealer_client.sharedclusters.list_available()
...
class ListOwn(base.DealerLister):
    ...
    def _get_resources(self, args):
        ...
        return dealer_client.sharedclusters.list_own()
...
class GetOwn(show.ShowOne):
    ...
    def take_action(self, args):
        dealer_client = self.app.client
        project = dealer_client.sharedclusters.get_own(args.id)
...
class DeleteAvailable(command.Command):
    ...
    def take_action(self, args):
        ...
        utils.do_action_on_many(
            lambda s: dealer_client.sharedclusters.delete_available(
                args.workspace, s
            ),
            args.id,
...
class DeleteOwn(command.Command):
    ...
    def take_action(self, args):
        ...
        utils.do_action_on_many(
            lambda s: dealer_client.sharedclusters.delete_own(s),
            args.id,
            "Request to delete shared cluster %s has been accepted.",
            "Unable to delete the specified shared cluster(s)."
        )
